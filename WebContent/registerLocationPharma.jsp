...
<title>Create Pharma Account</title>
</head>
<body>
<%
...
<div class="login-block">
    <form action="createpharma" method="post">
    ...
    <input type="text" value="" placeholder="Name Of Medical" id="Name Of Medical" name="nameofmed" />
...
<!--    <button class="button-33" type="button"onclick="getLocation()"><i class="fa-sharp fa-solid fa-location-dot fa-bounce" style="color: #fd2626;"></i>Get Location</button>
    ...
    <!--  <button class="button-73" role="button"><input type="submit" class="button-73"value="Create Account"> </button>-->
    <input type="submit" class="button-73"value="Submit"> 
  <!--    <center><a href="createuser.html"> &nbsp;Create Pharmacist Account </a></center> <br> -->
    <center>Not Pharamacist?</center> <br> 
    
    <a href="adminlogin.html"> &nbsp;Admin Login </a>
    <a href="GetLocationOnMap.html"> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; User Login </a>
