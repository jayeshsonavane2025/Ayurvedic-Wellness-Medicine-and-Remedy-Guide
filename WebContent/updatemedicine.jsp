                ...
                <nav class="navbar navbar-inverse">
                    ...
                    <div class="navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="sidebar-menu">
                            <div class="navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="sidebar-menu">
                            <li class="header">Pharamacist Session</li>
                            <li class="treeview">
                                <a href="index.html">
                             ...
                             <li class="treeview">
                                <a href="pharma_dashboard.html">
                                 <i class="fa  fa-user-nurse"></i> <span>Pharmacist</span>
                                </a>
                            </li>
                             <li class="treeview">
                                <a href="viewmedicine.jsp"> 
                                 <i class="fa fa-eye"></i> <span>View medicine</span>
                                </a>
                            </li>
                            <li class="treeview">
                                <a href="addmedicine.jsp">
                                 <i class="fa fa-square-plus"></i>  <span>Add Medicine</span>
                                </a>
                            </li>
                            <li class="treeview">
                                <a href="deletemedicine.jsp">
                                 <i class="fa  fa-user-nurse"></i> <span>Delete medicine</span>
                                </a>
                            </li>
                            <li class="treeview">
                                <a href="updatemedicine.jsp">
                                 <i class="fa fa-pen-to-square"></i><span>Update Medicine</span>
                                </a>
                            </li>
...
PreparedStatement pstmt=con.prepareStatement("select * from pharmaaccount where Name=? ");
 ...
 <tr>
     ...
     <td><%= rs.getInt(9) %></td>
       <td><%= rs.getString(10) %></td>
        <td> <a href="updatemedicinea.jsp?Medicine Name=<%= mname %>&Brand Name=<%= bname %>">Update Details</a></td>
