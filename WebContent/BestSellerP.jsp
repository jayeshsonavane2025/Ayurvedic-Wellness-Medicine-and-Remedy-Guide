...
<body class="cbp-spmenu-push"   >
    <div class="main-content">
                    ...
                    <div class="navbar-collapse" id="bs-example-navbar-collapse-1">
                         <ul class="sidebar-menu">
                            ...
                            <li class="treeview">
                             ...
                             <li class="treeview">
                                <a href="BestSellerP.jsp">
                                   <i class="fa  fa-arrow-up-right-dots"></i> <span>Our Best Seller Medicine</span>
                                </a>
                            </li>
                             <li class="treeview">
        ...
        <div class="sticky-nav">
            ...
            <div class="sticky-nav-options">
                ...
                <i class="fa fa-magnifying-glass" 
                        style="margin-right: 5px;"></i><a href="viewmedicine.jsp">Search Medicine</a></button>
        ...
        <h4>Our Best Seller Medicines(This Month)</h4>
        <div class="cards-container">
      <div class="card">
                <img src="./img/i3.jpg" class="card-img" alt="">
                <p class="card-title"> Reffron Tablet-15   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="my-button"> <a href="viewmedicine.jsp" style="color:blue;">View Details</a></button></p>
